...
#define SPI_SCK LATCbits.LATC2  //was C3
#define SPI_SDO LATCbits.LATC1  //was C5
#define SPI_SDI LATCbits.LATC0  // was C5
...
#define PHY_CS LATBbits.LATB1
#define PHY_CS_TRIS TRISBbits.TRISB1 //Our CS is hardwired to ground so I am using the unused port here
#define PHY_RESETn LATBbits.LATB2  //was C2
#define PHY_RESETn_TRIS TRISBbits.TRISB2
#define PHY_WAKE LATCbits.LATC4 //was c1
#define PHY_WAKE_TRIS TRISCbits.TRISC4
